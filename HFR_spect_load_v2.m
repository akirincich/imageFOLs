...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%% reading codar binary spectra files into matlab
%
%    This script follows COS documentation to load SeaSonde-type *.CSS
%    spectral files into matlab.  I believe it to work with most SeaSonde 
%    file types, but have not tested it extensively.
%
%
%   v2, 04/28/2014
%        added capability to not load D.q, the quality indicator, if a CSQ
%       file
%
%
%  Anthony Kirincich
